      ...
      <ul class="nav">
        ...
        <li class="nav-item menu-items">
          <a class="nav-link" href="./pages/forms/form.php">
            ...
            <span class="menu-title">Menambahkan Murid</span>
          </a>
        </li>
        <li class="nav-item menu-items">
        ...
        <div class="collapse" id="auth">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item">
              <a class="nav-link" href="pages/tables/tables_murid.php">
                Table Murid
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="pages/tables/tables_tabungan.php">
                Table Tabungan
              </a>
            </li>
          </ul>
        ...
        <div class="content-wrapper">
          <div class='card'>
            <div class='card-body'>
              ...
              $query = "SELECT * FROM guru WHERE username = '" . $_SESSION['username'] . "'";
              $result = mysqli_query($conn, $query);
              if ($result) {
                $row = mysqli_fetch_assoc($result);
                if ($row !== null) {
              ...
              ?>
              <form class="flex flex-col" enctype="multipart/form-data" action="proses/update_profile2_guru.php" method="post">
                ...
                <input class="bg-gray-700 text-gray-200 border-0 rounded-md p-2" id="age" type="date" name="tgl_lahir" value="<?php echo $tgl_lahir; ?>" />
                <br>
                <br>
                ...
                <div>
                  ...
                  <input placeholder="No. TLP" class="bg-gray-700 text-gray-200 border-0 rounded-md p-2 mb-4 focus:bg-gray-600 focus:outline-none focus:ring-1 focus:ring-blue-500 transition ease-in-out duration-150" type="number" name="notlp" value="<?php echo $notlp; ?>" />
                </div>
                ...
                <input class="bg-gray-700 text-gray-200 border-0 rounded-md p-2" id="photo" type="file" name="foto_profil" value="<?php echo $foto_profil; ?>" />
                <br>
                <br>
                <div>
