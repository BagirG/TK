  ...
  <div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      ...
      <ul class="nav">
        ...
        <li class="nav-item menu-items">
          <a class="nav-link" href="tabless.php">
            <span class="menu-icon">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          // Retrieve data from tb_murid table
          ...
          while ($row = $result->fetch_assoc()) {
            ...
            echo "<input type='checkbox' class='form-check-input' value='" . $row["id_murid"] . "' />";
            echo "</label>";
            echo "</div>";
            echo "</td>";
            ...
            echo "<td>" . $row["jk"] . "</td>";
            echo "<td><a href='#' onclick='return confirmDelete(" . $row["id_murid"] . ");' class='btn btn-danger'>Delete</a></td>";
            echo "<td><a href='#' onclick='openEditForm2(" . $row["id_murid"] . ")' class='btn btn-primary'>Edit</a></td>";
            echo "</tr>";
          ...
          if ($month != '' && $month != '0') { // added a check for '0' to cancel filter
            $sql .= " WHERE MONTH(tanggal_setoran) = '$month'";
          }
    ...
    <select id='month-filter' class='form-control'>
        ...
        <option value='12'>December</option>
          ...
          while ($row = $result->fetch_assoc()) {
            ...
            echo "<td>" . $row["nama"] . "</td>";
            echo "<td>" . $row["kelas"] . "</td>";
            echo "<td>" . $row["setoran"] . "</td>";
            echo "<td>" . $row["tanggal_setoran"] . "</td>";
            echo "<td>" . $row["penarikan"] . "</td>";
            echo "<td>" . $row["tanggal_penarikan"] . "</td>";
            echo "<td>" . $row["saldo"] . "</td>";
            echo "<td><a href='#' onclick='return confirmDelete2(" . $row["id_tabungan"] . ");' class='btn btn-danger'>Delete</a></td>";
            echo "<td><a href='#' onclick='openEditForm(" . $row["id_tabungan"] . ")' class='btn btn-primary'>Edit</a></td>";
            echo "</tr>";
            $no++;
          }
