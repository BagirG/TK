                  ...
                  <div class="row">
                    <div class="col-9">
                      <div class="d-flex align-items-center align-self-start">
                        <h3 class="mb-0"><?php include 'proses/total_tabungan.php'; ?></h3>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-9">
                      <div class="d-flex align-items-center align-self-start">
                        <h3 class="mb-0"><?php include 'proses/total_murid.php'; ?></h3>
                  ...
                  <div class="row">
                    <div class="col-9">
                      ...
                      <div class="d-flex align-items-center align-self-start">
                        ...
                        <h3 class="mb-0"><?php include 'proses/daily_income.php'; ?></h3>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-9">
                      <div class="d-flex align-items-center align-self-start">
                        <h3 class="mb-0"><?php include 'proses/penarikan.php'; ?></h3>
