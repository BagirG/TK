...
<body>
    ...
    <div class="mt-4 flex flex-col bg-gray-100 rounded-lg p-4 shadow-sm">
        ...
        $sql = "SELECT * FROM tabungan WHERE id_murid=?";
        ...
        ?>
            <form action="proses/tambah_tabungan.php" method="post">
                ...
                <div class="mt-4 flex flex-row space-x-2">
                    <div class="flex-1">
                        ...
                        <input placeholder="" class="w-full bg-white rounded-md border-gray-300 text-black px-2 py-1" id="nominal" type="text" name="nominal" value="">
                    </div>
