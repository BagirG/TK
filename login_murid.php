...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (empty($username) || empty($password)) {
    ...
    $sql = "SELECT * FROM tb_murid WHERE username = ? AND pw = ?";
    ...
    if ($result->num_rows > 0) {
      ...
      header('Location: beranda_murid.php'); // Ganti dengan halaman yang sesuai
      exit;
    } else {
      ...
      <div class="card2">
        <form class=" form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
          ...
          <div>
            ...
            <!-- <p style="text-align:center">Belum memiliki akun silahkan <a href="Login2.php">daftar</a></p>
        -->
          </div>
        </form>
      </div>
